// Script to add example classrooms to Firestore as admin
// Run this with: node addClassroomsAsAdmin.js
...
async function addClassrooms() {
  try {
    ...
    // Sign in as admin
    await signInWithEmailAndPassword(auth, 'admin@plv.edu.ph', 'Admin@123456');
